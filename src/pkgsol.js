...
const getShield = ({ name, version, shieldsColor, shieldsAuto }) => {
  ...
  return `![${name} npm badge)](${
    shieldsAuto 
      ...
      ? `ttps://img.shields.io/badge/solidity-${fixVersion}-${shieldsColor}?logo=solidity.svg`
      : `https://img.shields.io/solidity/v/${name}.svg?colorB=${shieldsColor}`
  })`;
};
